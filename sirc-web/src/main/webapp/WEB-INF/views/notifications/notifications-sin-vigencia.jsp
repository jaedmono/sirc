...
<base:basePage containerClass="home-container">
	...
	<jsp:body>
		...
		<spring:message code="header.administration.notifications.vigencia"
			var="textTitle" />
	    ...
	    <div class="container">
					...
					<div
					    ...
					    <table id="notifications1"
					        ...
					        <tr>
					            ...
					            <th>Días sin vigencia </th>
					        </tr>
					        </thead>
					        <tbody>
						        <c:forEach items="${tarjetasControlSinVigencia}"
									var="tarjeta">
							        <tr>
			...
			<div class="row">
				<div class="col-md-12">
				<label>% Tarjetas de Control sin vigencia: ${porcentaje}</label>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
				<label>Promedio de días transcurridos desde que las Tarjetas perdieron la vigencia: ${promedio}</label>
				</div>
			</div>
	</div>
	</jsp:body>
