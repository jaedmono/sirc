...
@media(max-width:767px){
    ...
    .tab-pane{
        ...
        <script src="${pageContext.request.contextPath}/resources/js/dev/company.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/dev/driver/form-validations.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/dev/driver/driver.js"></script>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="icon-addon addon-md">
                                                            <input
                                                                    ...
                                                                    type="text" data-parsley-maxlength="100" class="form-control"
                                        ...
                                        <div class="col-md-12" style="padding: 0px;">
                                            ...
                                            <div class="col-md-3">
                                                <div style="clear: both">
                                                    ...
                                                    <input type="hidden" id="uriFotoCOnductor"
                                                           name="conductorDTO.uriFoto" value="${driverDTO.conductorDTO.uriFoto}">
                                                    <c:choose>
                                                        <c:when
                                                            test="${not empty driverDTO.conductorDTO.uriFoto}">
                                                            <img id="previewPicture"
                                                                frameborder="0" scrolling="no" width="120px" height="150px"
                                                                src="${contextPath}/get-img?id=${driverDTO.idConductor}"></img>
                                                        </c:when>
                                                        <c:when
                                            ...
                                            <div class="row">
                                                <div class="col-md-12"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="icon-addon addon-md">
                                                            <input
                                                                placeholder="Fecha exp. doc. dd/mm/aaaa" class="form-control"
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group eq-ui-input-field">
                                                            <div class="icon-addon addon-md">
                                                                <form:input placeholder="No. Planilla" name="nroPagoPila" id="approbal_number" max="999999999999999" type="number"
                                                                        class="form-control noscroll" path="planillas[${status.index}].numeroAprobacion"
                                                                        value="${planilla.numeroAprobacion}" required="true" />
                                                                <label class="fa fa-barcode"></label>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseVehicle" class="panel-collapse collapse in">
                                <div class="panel-body">
                                                    ...
                                                    <div class="eq-ui-input-field">
                                                        <div class="form-group icon-addon addon-md">
                                                            <input id="fechaVencimientoSoat"
                                                                    ...
                                                                    placeholder="Fecha ven. SOAT dd/mm/aaaa" required
                                                    ...
                                                    <div class="eq-ui-input-field">
                                                        <div class="form-group icon-addon addon-md">
                                                            <input id="fechaVencimientoRtm"
                                                                    ...
                                                                    placeholder="Fecha ven. RTM dd/mm/aaaa" required
                                                    ...
                                                    <div class="eq-ui-input-field">
                                                        <div class="form-group icon-addon addon-md">
                                                            <input id="fechaVencimientoTO"
                                                                    ...
                                                                    placeholder="Fecha ven. TO dd/mm/aaaa" required
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="icon-addon addon-md">
                                                        <select class="form-control" id="idMetodoCobro" name="idMetodoCobro" placeholder="Método de cobro">
                                    ...
                                    <div id="fechasTC" class="row form-group"
                                         style="display: none;">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div id="dueDate" class="form-group eq-ui-input-field">
                                                                        <label>Fecha de vencimiento</label>
                                                                        <div style="padding: 0px; margin-top: -5px; margin-bottom: 5px; text-align: justify;">
                                                                            <span>La tarjeta de control tiene una vigencia mensual. Si no se refrenda </span>
                                                                            <span style="color: #000; font-weight: bold; text-decoration: underline;">antes de la fecha de vencimiento</span>
                                                                            <span> el sistema la cancelará automáticamente y será necesario expedir una nueva.</span>
                                                                        </div>
                                                                        <div class="icon-addon addon-md">
                                                                            <input placeholder="Fecha de vencimiento" name="fechaVigencia" type="text" disabled
                                                                                   value="<fmt:formatDate value="${driverDTO.fechaVigencia}" pattern="dd/MM/YYYY"/>"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group eq-ui-input-field">
                                                                        ...
                                                                        <div class="icon-addon addon-md">
                                                                            <div style="padding: 0px; margin-top: -5px; margin-bottom: 5px; text-align: justify;">
                                                                                <span>Este sistema permite utilizar la misma tarjeta de control por un periodo de 12 meses consecutivos si se refrenda mensualmente antes de la fecha de vencimiento en cumplimiento del Decreto Nacional 1079 de 2015.</span>
                                                                                <span style="color: #000; font-weight: bold; text-decoration: underline;">Este número de tarjeta de control no podrá ser utilizado después de ${fechaValidezTC}.</span> -->
                                                                                <!-- <span> Antes de dicha fecha será necesario cancelar la tarjeta de control y expedir una nueva.</span> -->
                                                                        <!--</div>
                                                                    </div>-->
                                                                    </div>
                                                                </div>
